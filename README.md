...
-[Live Demo Link](https://react-math-magicians-nhj4.onrender.com)
...
```sh
  ...
  git clone git@github.com:veronica365/react-math-magicians.git
  open the repo folder `react-math-magicians`
```
...
Feel free to check the [issues page](https://github.com/veronica365/react-math-magicians/issues).
